...
@section('content')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            {{-- <span class="validation-msg text-danger" id="name-error"></span> --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="brand_id" class="selectpicker form-control"
                                                    ...
                                                    <@foreach ($all_brand as $brand) <option value="{{ $brand->id }}">{{ $brand->name }}</option> @endforeach </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="category_id" required class="selectpicker form-control"
                                                    ...
                                                    <option value="">--select--</option>
                                                    <@foreach ($all_category as $category) <option value="{{ $category->id }}">{{ $category->category_name }}</option> @endforeach </select>
                                    ...
                                    <div id="alert-qty" class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger" id="alertError"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        //             error.html('This field is required aumlan.');
        ...
        //     if ($('#name').val('')) {
        //         $('#nameError').val("Product name required");
        //     }else{
            ...
            if (validate()) {
                ...
                $.ajax({
                    ...
                    error: function(error) {
                        ...
                        // $('#barcodeError').text(error.responseJSON.errors.name);
                        $('#brandError').text(error.responseJSON.errors.brand_id);
                        $('#categoryError').text(error.responseJSON.errors.category_id);
                        $('#unitError').text(error.responseJSON.errors.unit_id);
                        $('#priceError').text(error.responseJSON.errors.price);
                        $('#costError').text(error.responseJSON.errors.cost);
                        $('#alertError').text(error.responseJSON.errors.alert_quantity);
                        // if (error.responseJSON.errors.name) {
                        //     $("#nameError").text(error.responseJSON.errors.name);
                        // } else if (error.responseJSON.errors.code) {
                        //     $("#codeError").text(error.responseJSON.errors.code);
                        // }
                    },
                });
