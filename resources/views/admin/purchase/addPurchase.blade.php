                ...
                if (!selected_product.includes($('#result').val())) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            row = row +
                                "<td><input type='number' min='1' name='qty[]' value='0' class='qty quenty" +
                                id + "'></td>"
                            row = row +
                                "<td class='receive' style='display: none;' ><input  id='receive4" +
                                id + "' type='number' name='received[]' onkeyup='mYFunction(" + id +
                                ")' class='receive' /></td>"
