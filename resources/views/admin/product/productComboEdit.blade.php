...
browser_spellcheck: true
    ...
    <script type="text/javascript">
        ...
        //                     if ($(this).val() == data['id']) {
        //                         swal("Warning!", "Dupplicate Product Not Allowed!", "warning");
        ...
        //                     var newRow = $("<tr>");
        //                     var cols = '';
        //                     cols += '<td>' + data['name'] + ' [' + data['barcode_symbology'] + ']</td>';
        //                     cols += '<td><input type="number" class="form-control qty" name="product_qty[]" value="1" step="any"/></td>';
        //                     cols += '<td><input type="number" class="form-control unit_price" name="unit_price[]" value="' + data['price'] + '" step="any" readonly/></td>';
