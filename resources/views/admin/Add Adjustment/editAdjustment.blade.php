    ...
    <section class="forms">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="text" id="adjustment_id" name="adjustment_id"
                                                        value="{{ $ad_id }}">
                                                    ...
                                                    <select required name="warehouse_id" id="warehouse_id"
                                                        ...
                                                        @foreach ($warehouse as $warehouse)
                                                            <option value="{{ $warehouse->id }}" @if ($adjusmentedit->warehouse_id == $warehouse->id) {{ 'selected="selected"' }} @endif>
                                                ...
                                                <div class="table-responsive mt-3">
                                                    <table id="myTable" class="table table-hover order-list">
                                                        ...
                                                        <tbody id="each_product">
                                                            @foreach ($productadjusments as $productadjusments)

                                                                <tr>

                                                                    <td>{{ $productadjusments->name }}
                                                                    </td>
                                                                    <input type='hidden' min='1' name='p_id[]'
                                                                        value={{ $productadjusments->id }} class='r'></td>
                                                                    <td>{{ $productadjusments->barcode_symbology }}
                                                                    </td>
                                                                    <td><input type='number' min='1' name='qty[]'
                                                                            value='{{ $productadjusments->p_qty }}'
                                                                            class='qty quenty'></td>
                                                                    <td>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="5" class="form-control"
                                                        name="note">{{ $productadjusments2->note }}</textarea>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script>
            ...
            $('#addProductCategoryFrom').on('submit', function(event) {
                ...
                $.ajax({
                    url: '/admin/add-productWarehouse2/' + id,
                    method: "POST",
                    data: formData,
                    contentType: false,
                    cache: false,
